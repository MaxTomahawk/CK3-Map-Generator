...
function handleKeyup(event) {
  ...
  else if (shift && code === "KeyB") toggleBaronies();
  else if (shift && code === "KeyS") toggleSpecialBuildings();
  else if (shift && code === "KeyP") togglePOIs();
  ...
  else if (shift && code === "KeyR") toggleRulersView();
  ...
  else if (shift && code === "KeyT") toggleTitles();
